...
setwd("~/Dropbox/projects/tolerance-corruption/appendix")
library(ordinal)
library(arm)
library(car)
# library(papeR)
...
Data_GB <- read_csv("~/Dropbox/projects/tolerance-corruption/analysis/data-gb.csv")
Data_LB <- read_csv("~/Dropbox/projects/tolerance-corruption/analysis/data-lb.csv")
Data_WVS <- read_csv("~/Dropbox/projects/tolerance-corruption/analysis/data-wvs.csv")
